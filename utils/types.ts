...
export enum ProtocolErrors {
  ...
  LPC_INVALID_BTOKEN_POOL_ADDRESS = "35", // 'The liquidity of the reserve needs to be 0'
  ...
  LP_CALLER_MUST_BE_AN_BTOKEN = "63",
...
export type iBlendPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "DAI" | "USDC" | "BLEND" | "LINK" | "WBTC" | "WETH"
>;
...
export type iMaticPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "DAI" | "USDC" | "USDT" | "WBTC" | "WETH" | "WMATIC" | "BLEND"
>;
...
export type iAvalanchePoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "WETH" | "DAI" | "USDC" | "USDT" | "BLEND" | "WBTC" | "AVAX"
>;

export type iMultiPoolsAssets<T> = iAssetCommon<T> | iBlendPoolAssets<T>;

export type iBlendPoolTokens<T> = Omit<iBlendPoolAssets<T>, "ETH">;
...
export interface IBaseConfiguration {
  ...
  StkBlendProxy?: iParamsPerNetwork<tEthereumAddress>;
...
export interface IBlendConfiguration extends ICommonConfiguration {
  //ReservesConfig: iBLENDPoolAssets<IReserveParams>;
}
